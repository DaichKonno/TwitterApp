...
class TimeLineTableViewController: UITableViewController {
    ...
    var dataArray:[[String:String]] = [
        ["title":"タイトル1",
            "image":"http://www.hkr.ne.jp/~rieokun/frog/nihonama.jpg"
        ],
        ["title":"タイトル2",
            "image":"http://www.hkr.ne.jp/~rieokun/frog/nihonama7.jpg"
        ]
    ]
...
//        }
    ...
    @IBAction func tweetbutton(sender: UIBarButtonItem) {if SLComposeViewController.isAvailableForServiceType(SLServiceTypeTwitter) {
